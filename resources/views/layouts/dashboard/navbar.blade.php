<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <h2 class="navbar-brand brand-logo" >
          SMBBIT
        </h2>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <ul class="navbar-nav d-none d-md-block">
          <li class="nav-item dropdown">
           ...
           <div class="navbar-toggler">Library Management System</div>
             <!--<a class="nav-link dropdown-toggle" id="LanguageDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <i class="flag-icon flag-icon-pk"></i>
              English
            </a>
         
             <a class="" id="LanguageDropdown" href="#" data-toggle="" aria-expanded="false">
              <i class="flag-icon flag-icon-book"></i>
